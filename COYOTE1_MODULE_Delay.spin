''=======================================================================  
'' TITLE: COYOTE1_MODULE_Delay.spin
''
'' DESCRIPTION:
''
'' COPYRIGHT:
...
_module_entry
                        ...
                        mov     p_socket_feedback,  p_module_control_block
                        add     p_socket_feedback,  #(hw#MCB_OFFSET__SOCKET_EXCHANGE + (3 << 2)) 
...
_lock2                  lockset hw#LOCK_ID__MEMBUS   wc
              if_c      jmp     #_lock2
                        ...
                        'Drop delayed value by 1/2, with sign extension
                        'sar     sram_data, #1
                        
                        rdlong  y, p_socket_feedback
                        shr     y, #15
                        mov     x, sram_data
