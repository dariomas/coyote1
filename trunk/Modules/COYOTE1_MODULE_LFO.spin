...
_module_entry
                        ...
                        add     p_socket_depth,      #(hw#MCB_OFFSET__SOCKET_EXCHANGE + (2 << 2)) 
                        mov     p_socket_shape,      p_module_control_block
                        add     p_socket_shape,      #(hw#MCB_OFFSET__SOCKET_EXCHANGE + (3 << 2)) 
                        ...
                        add     p_socket_lfo,        #(hw#MCB_OFFSET__SOCKET_EXCHANGE + (5 << 2)) 
                        ...
                        add     p_socket_rate_blink, #(hw#MCB_OFFSET__SOCKET_EXCHANGE + (7 << 2)) 
...
_rate_done
        ...
        if_nz           jmp      #_tap_done
                        ...
                        mov      rate_step_16_16_fxp, x
                        shl      rate_step_16_16_fxp, #1

                        mov      angle_16_16_fxp, #0                            ' Clear the angle
...
_waveshape_done
                        ...
                        test    old_angle_16, ANGLE_360       wz
                if_nz   jmp     #_edge_detect_done
                        test    angle_16, ANGLE_360           wz
                if_nz   mov     blink_counter, BLINK_ON_TIME
...
QUOTIENT_MASK_16            long  $0000ffff        'Divide returns 19 bit quotient     
...
BLINK_ON_TIME               long  ((hw#AUDIO_SAMPLE_RATE)/20)  ' On time (in samples) of "Rate Blink" output
...
p_socket_tap              res     1             ' Pointer to depth socket  
p_socket_depth            res     1             ' Pointer to depth socket
p_socket_shape            res     1             ' Pointer to depth socket
